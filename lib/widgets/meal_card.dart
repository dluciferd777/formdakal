// lib/widgets/meal_card.dart - YENİ RENK SİSTEMİ
...
class _MealCardState extends State<MealCard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // YENİ RENK SİSTEMİ - TAKVİMLE AYNI
    final fatColor = Colors.yellow;      // YAĞ → SARI
    final carbColor = Colors.blue;       // KARBONHIDRAT → MAVİ
    final proteinColor = Colors.green;   // PROTEİN → YEŞİL
    final calorieColor = Colors.red;     // KALORİ → KIRMIZI
          ...
          Container(
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Icon(widget.icon, color: proteinColor, size: 24), // YEŞİL İKON
                      ...
                      children: [
                        Text(widget.totalCalories.toInt().toString(),
                            style: theme.textTheme.headlineSmall?.copyWith(
                                color: calorieColor, // KALORİ KIRMIZI
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.add, color: proteinColor, size: 24), // YEŞİL ADD BUTONU
                      ),
                    ),
                  ],
                ),
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    _buildMacroInfo('Yağ', widget.totalFat, fatColor, isDarkMode),      // SARI
                    _buildMacroInfo('Karb', widget.totalCarbs, carbColor, isDarkMode),  // MAVİ
                    _buildMacroInfo('Prot', widget.totalProtein, proteinColor, isDarkMode), // YEŞİL
                  ],
                ),
                      ...
                      builder: (context, constraints) => Row(
                        children: [
                          Container(
                              ...
                              height: 4,
                              decoration: BoxDecoration(
                                  color: fatColor, // YAĞ SARI
                                  borderRadius: BorderRadius.circular(4))),
                          Container(
                              width: constraints.maxWidth * carbsRatio,
                              height: 4,
                              color: carbColor), // KARB MAVİ
                          Container(
                              width: constraints.maxWidth * proteinRatio,
                              height: 4,
                              decoration: BoxDecoration(
                                  color: proteinColor, // PROTEİN YEŞİL
                                  borderRadius: BorderRadius.circular(4))),
                        ],
                      ),
                    ),
                          ...
                          return ListTile(
                            ...
                            subtitle: RichText(
                              text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text: '${food.grams.toInt()} g | ',
                                    style: TextStyle(color: isDarkMode ? Colors.grey[400] : Colors.grey[600]),
                                  ),
                                  TextSpan(
                                    text: 'P: ${food.totalProtein.toInt()}g',
                                    style: TextStyle(color: proteinColor), // PROTEİN YEŞİL
                                  ),
                                  TextSpan(
                                    text: ', K: ${food.totalCarbs.toInt()}g',
                                    style: TextStyle(color: carbColor), // KARB MAVİ
                                  ),
                                  TextSpan(
                                    text: ', Y: ${food.totalFat.toInt()}g',
                                    style: TextStyle(color: fatColor), // YAĞ SARI
                                  ),
                                ],
                              ),
                            ),
